...
SUPPORTED_PYTHON_VERSIONS = (2.6, 2.7, 3.3)
        ...
        try:
            ...
            if mime == ("application/x-python-code", None):
                ...
                if python_version not in SUPPORTED_PYTHON_VERSIONS:
                    raise WrongBytecode(
                        "We only support bytecode 2.6, 2.7 and 3.3: %r is %2.1f bytecode"
                ...
                if PYTHON_VERSION not in SUPPORTED_PYTHON_VERSIONS:
                    raise CannotCompile(
                        "We need Python 2.6, 2.7 or 3.3 to compile source code; you are running Python %s"
                        % PYTHON_VERSION
                    )
